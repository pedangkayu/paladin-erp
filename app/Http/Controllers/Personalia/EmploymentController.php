...
class EmploymentController extends Controller
{
	public function getIndex(){
		...
		->orWhere('id_status',2)
		->orWhere('id_status',3)
		->select('data_employment.*','data_recruitment.posisi')
		->paginate(10);

		return view('Personalia.Employment.index',[
			'items' => $items
			]);
	...
	public function getCreate(Request $req){
		...
		return view('Personalia.Employment.create',[
	...
	public function getList(){
		...
		return view('Personalia.Employment.list',[
			'items' => $items
			]);
	}
	...
	public function getDetail($id){
		...
		return view('Personalia.Employment.detail',[
			'data' => $data,
			'detail' => $detail,
			]);
	}
