...
class RecruitmentController extends Controller
{
  ...
  */
  ...
  public function getIndex(){
    ...
    return view('Personalia.Recruitment.index',[
      'items' => $items,
      ]);
  }
  ...
  public function getCreate(){
    ...
    return view('Personalia.Recruitment.create',[
 ...
 public function getUpdate(Request $req){
  ...
  $data = data_recruitment::find($req->id);
   ...
   return view('Personalia.Recruitment.edit',[
    'data' => $data
    ]);
 }
 ...
 public function getDetail(Request $req){
  ...
  return view('Personalia.Recruitment.detail',[
      'data' => $data
    ]);
 }
