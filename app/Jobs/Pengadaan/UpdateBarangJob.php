    ...
    public function handle(){
        ...
        try{
            ...
            $barang->update([
                ...
                'reuse'          => $this->req['reuse'],
				'lokasi'         => $this->req['lokasi'],
				'merk'           => $this->req['merk'],
				'dimensi'		 => $this->req['dimensi'],
				'kondisi'		 => $this->req['kondisi'],
				'tahun_beli'	 => $this->req['tahun_beli'],
                'kode_lama'        =>$this->req['kode_lama'],
                'nilai_penyusutan' =>$this->req['nilai_penyusutan'],
                'waktu_penyusutan' =>$this->req['waktu_penyusutan']
            ]);
            ...
            if($this->req['harga_jual'] != $this->req['last_harga_jual'])
				...
				// Pengkodean
                // $tipe = $this->req['tipe'] == 1 ? 'O-' : 'B-' : 'I-' ;
                if($this->req['tipe'] == 1){
                     $tipe ='O-';
                }elseif ($this->req['tipe'] == 2) {
                     $tipe ='B-';
                }else{
                     $tipe ='I-';
                }
            ...
            \Loguser::create('Melakukan perubahan terhadap data master gudang Kode. ' . $barang->kode);
