...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Logistik/lpgc.js') }}"></script>
...
@section('title')
Laporan Gudang Kecil
@endsection

@section('content')

<form method="get" action="{{ url('/reportlogistik/lpgcprint') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
			...
			<div class="grid simple">
				...
				<div class="grid-body no-border">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<select name="id_gudang" class="form-control">
									...
									<option value="{{ $item->id_gudang }}">{{ $item->nm_gudang }}</option>
									@endforeach
								</select>
							</div>
						...
						<input type="hidden" name="id_gudang" value="{{ Me::subgudang()->id_gudang }}">
						@endif
					</div>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th> Gudang </th>
						<th width="15%" class="text-middle">Tanggal</th>
					</tr>
				</thead>
