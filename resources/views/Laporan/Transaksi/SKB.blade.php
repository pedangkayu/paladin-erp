...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Transaksi/skb.js') }}"></script>
...
@section('title')
Rekap Surat Keluar Barang
@endsection

@section('content')

<form method="get" action="{{ url('/rekap/printskb') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
