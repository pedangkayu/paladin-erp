...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Transaksi/spb.js') }}"></script>
...
<form method="get" action="{{ url('/rekap/printspb') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
	...
	<div class="grid-body no-border">
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					<th>No.</th>
					<th class="text-middle">PMB/PMO</th>
