...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Transaksi/pmbu.js') }}"></script>
...
<form method="get" action="{{ url('/rekap/printpmbu') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
