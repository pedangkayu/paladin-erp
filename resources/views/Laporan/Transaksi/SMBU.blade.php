...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Transaksi/smbu.js') }}"></script>
...
@section('title')
Rekap Surat Mutasi Barang Unit
@endsection

@section('content')

<form method="get" action="{{ url('/rekap/printsmbu') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
				...
				<div class="grid-body no-border">
					...
					<div class="row">
						<div class="col-sm-9">
							...
							<div class="col-sm-8">
								<div class="form-group">
									<label for="bulan">Gudang Pemohon</label>
									<select class="select" style="width:100%;" name="pemohon" id="pemohon">
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="text-middle">No SMBU</th>
