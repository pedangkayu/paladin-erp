...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Transaksi/rwt.js') }}"></script>
...
<form method="get" action="{{ url('/rekap/printrinap') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
						...
						<div class="row">
							<div class="col-sm-8">
								<div class="form-group">
									...
									<select class="select" style="width:100%;" name="id_kamar" id="id_kamar">
										<option value="">Semua Kamar</option>
										@foreach ($kamar as $key )
											<option value="{{$key->id_kamar}}">{{$key->kode_kamar}} &nbsp;{{$key->nm_kamar}}</option>
										@endforeach
									</select>
								</div>
							</div>
