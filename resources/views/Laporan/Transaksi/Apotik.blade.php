...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Transaksi/apotik.js') }}"></script>
...
<form method="get" action="{{ url('/rekap/printapotik') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
				...
				<div class="grid-body no-border">
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
								<label for="kategori">Kategiri</label>
									<select class="select" style="100%" id="kategori" name="kategori">
