...
<script type="text/javascript" src="{{ asset('/js/Laporan/Keuangan/rekapsumbangan.js') }}"></script>
...
@section('title')
Rekap Pembayaran Sumbangan
@endsection

@section('content')


<form  method="get" action="{{url('/rekap/printsumbangan')}}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
