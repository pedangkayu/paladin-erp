...
<script type="text/javascript" src="{{ asset('/js/Laporan/Keuangan/subsidi.js') }}"></script>
...
@section('title')
Rekap Pembayaran Subsidi
@endsection

@section('content')


<form  method="get" action="{{url('/rekap/printsubsidi')}}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
