...
<script type="text/javascript" src="{{ asset('/js/Laporan/Keuangan/deposit.js') }}"></script>
...
@section('title')
Rekap Pembayaran Deposit
@endsection

@section('content')


<form  method="get" action="{{url('/rekap/printdeposit')}}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
