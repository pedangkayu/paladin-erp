...
<script type="text/javascript" src="{{ asset('/js/Laporan/Keuangan/Rekapasuransi.js') }}"></script>
...
@section('title')
Rekap Pembayaran Asuransi
@endsection

@section('content')


<form  method="get" action="{{url('/rekap/printasuransi')}}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
					...
					<div class="row">
						<div class="col-sm-9">
							...
							<div class="row">
								<div class="col-sm-7">
									<div class="form-group">
										<label for="asurasni">Jenis Pembyaran</label>
										<select class="select" style="width:100%" name="asuransi" id="asuransi">
											<option value="">Pilih Semua</option>
											@foreach($asuransi as $data)
												<option value="{{$data->id_asuransi}}">{{$data->nm_asuransi}}</option>
											@endforeach
										</select>
									</div>
								</div>								
				...
				<div class="grid-body no-border text-center">
					...
					{{-- 	<div class="col-sm-8">
							<div class="form-group text-left">
								<label>Riport</label>
								<div class="radio">
									<input type="radio" name="exx" class="radio-src" value="1" id="a" checked>
									<label for="a">Excell</label>

									<input type="radio" name="exx" class="radio-src" value="2" id="b">
									<label for="b">No Excell</label>
								</div>
							</div>
						</div> --}}
						{{-- ==Radio excel== --}}
