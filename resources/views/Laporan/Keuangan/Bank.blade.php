...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/Laporan/Keuangan/Bank.js') }}"></script>
...
@section('title')
Rekap Pembayaran Bank
@endsection

@section('content')


<form  method="get" action="{{url('/rekap/printbank')}}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
					...
					<div class="row">
						<div class="col-sm-9">
							...
							<div class="row">
								<div class="col-sm-7">
									<div class="form-group">
										<label for="asurasni">Jenis Bank</label>
										<select class="select" style="width:100%" name="bank" id="bank">
