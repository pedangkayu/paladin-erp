...
<form method="post" action="{{ url('/gr/creategr') }}">
	...
	<div class="row">
		<div class="col-sm-8">
			...
			<div class="grid simple">
				<div class="grid-title no-border">
				<button data-toggle="modal" data-target="#myModal" onclick="otheritems();" type="button" class="btn btn-primary btn-small pull-right"><i class="fa fa-plus"></i> Tambah items lain</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="grid simple">
					<div class="grid-title no-border">
						<h4><span class="total-other-item">0</span> item <strong>ditemukan</strong></h4>
					</div>
					<div class="grid-body no-border">
							...
							<thead>
								...
								<tr>
									<td colspan="4">
										<div class="row">
											<div class="col-sm-5">
												<input type="text" name="kode_other" placeholder="Kode..." style="width:100%;">
											</div>
											<div class="col-sm-7">
												<input type="text" name="nm_barang_other" placeholder="Nama Barang/Obat..." style="width:100%;">
											</div>
										</div>
									</td>
								</tr>
							</thead>
							<tbody class="other-items">
								<tr>
									<td colspan="4">Tidak ditemukan</td>
								</tr>
							</tbody>
						...
						<div class="pagin-other-items"></div>
