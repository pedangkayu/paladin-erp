...
@section('title')
	{{ empty($no_sph) ? 'Buat Penawaran Harga' : 'Tambahkan ke SPH No. ' . $no_sph }}
@endsection

@section('content')
	<form method="post" action="{{ url('/sph/create') }}" id="simpan">
			...
			<div class="col-sm-9">
				...
				<div class="grid simple">
					...
					<div class="table-responsive">
						...
						@if($id < 1)
						<h4><a href="{{ url('/sph/select') }}" class="btn btn-link"><i class="fa fa-plus"></i> Tambahkan lebih banyak item barang</a></h4>
						@endif
					</div>
			...
			<div class="col-sm-3">
				...
				<div class="grid simple">
					...
					<div class="grid-body no-border">
						...
						<div class="form-group">
							<div class="checkbox">
								<input type="checkbox" name="next" value="1" id="next" checked="checked">
								<label for="next">Simpan untuk SPH selanjutnya</label>
							</div>
						</div>
						...
						<!-- <div class="form-group">
							<div class="checkbox">
								...
								<label for="po">Jadikan PO Tanpa SPH</label>
							</div>
						</div> -->
						@endif
						...
						<div class="form-group btn-proses">
							...
							@endif
							<a href="{{ url('/sph') }}" class="btn btn-primary btn-block">Batal</a>
						</div>
