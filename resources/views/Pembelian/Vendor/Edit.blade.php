		...
		<div class="col-sm-8">
			...
			<div class="grid simple">
				...
				<form method="post" action="{{ url('/vendor/edit') }}">
					...
					<div class="form-group">
	                    <label class="form-label" for="pemilik">No NPWP *</label>
	                    <span class="help">e.g. "10021022"</span>
	                    <div class="controls">
	                     	<input type="text" class="form-control" name="no_npwp" id="no_npwp" value="{{ $vendor->no_npwp }}" required>
	                    </div>
	                </div>
