		...
		<div class="col-sm-8">
			...
			<div class="grid simple">
				...
				<form method="post" action="{{ url('/vendor/add') }}">
					...
					<div class="form-group">
	                    <label class="form-label" for="nm_vendor">No NPWP *</label>
	                    <span class="help">e.g. "10017788"</span>
	                    <div class="controls">
	                     	<input type="text" class="form-control" name="no_npwp" id="no_npwp" value="{{ old('no_npwp') }}" required>
	                    </div>
	                </div>
