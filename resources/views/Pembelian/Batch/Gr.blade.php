...
@section('meta')
	...
	<script type="text/javascript" src="{{ asset('/js/modpembelian/batch/gr.js') }}"></script>
@endsection

@section('title')
	List Good Receive to Batch
@endsection
				...
				<div class="grid-body no-border">
					...
					<div class="form-group">
						<div class="checkbox check-info">
							<input type="checkbox" name="belum" id="belum">
							<label for="belum">Tampilkan yang belum saja</label>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<a href="{{ url('/batch') }}" class="btn btn-primary btn-block">Master Batch</a>
					</div>
