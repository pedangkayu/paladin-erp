...
<div class="container">
  <div class="row login-container">  
	    ...
	    <div class="row">
			<div class="col-md-11">
               <center>
			   <p style="margin-top: 80px;">&copy; 2016 - <?php echo date('Y'); ?> &middot; PALADIN ERP &middot; All right reserved &middot;  <a href="{{ url('/vacancy/list/') }}">Lowongan Kerja</a></p>
			   <small>only for internal purposes. all activities and transaction data will be stored in our database</small>
			   </center>
			</div>
	    </div>
