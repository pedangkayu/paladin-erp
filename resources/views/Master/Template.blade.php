...
<head>
	...
	{{-- Notif mutasi --}}
	<script type="text/javascript" src="{{ asset('/js/notif/notifmutasi.js') }}"></script>
	<!-- Penambahan -->
	@yield('meta')
...
<body class="">
	...
	<div class="header navbar navbar-inverse "> 
		...
		<div class="navbar-inner">
        	...
        	<li class="quicklinks"> <span class="h-seperate"></span></li>
        	{{-- <li class="quicklinks">
	            	<div class="fa fa-inbox"  title="Permintaan Mutasi Barang sedang menunggu konfirmasi dari anda"></div>
        	</li> --}}
        	<li class="quicklinks"> <span class="h-seperate menunggu-konfir" title="Permintaan Mutasi Barang sedang menunggu konfirmasi dari anda" style="background:#ff0000;"></span></li>
        	@if(env('CHAT'))
