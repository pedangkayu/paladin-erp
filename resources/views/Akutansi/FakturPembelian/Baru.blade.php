...
@section('content')
<form method="post" action="{{ url('/fakturpembelian/baru') }}">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="alamat" rows="6" readonly="readonly"></textarea>
							</div>

							<div class="form-group">
								<label for="po">No. Purchase Order</label>
								<div class="input-group">
									<input type="text" name="no_po" value="" class="form-control" readonly="readonly">
								      <span class="input-group-btn">
						...
						<div class="col-sm-6">
							...
							<div class="fomr-group">
								<div class="checkbox checkbox check-success"> <!-- <a href="#">Trouble login in?</a>&nbsp;&nbsp; -->
								  <input type="checkbox" id="checkbox1" name="cash" value="1">
								  <label for="checkbox1">Bayar langsung </label>
								</div>
							</div>
							<div class="form-group cash hide">
								...
								<div class="input-group transparent">
									...
									<input type="number" value="0" name="jumlah_pembayaran" id="jumlah_pembayaran" class="form-control text-right">
								</div>
							</div>
					...
					<div class="table-responsive">
						<table class="table table-hover">
							<thead>
								<tr>
									<th width="15%">Kode</th>
									<th width="40%" class="text-left">Barang</th>
					...
					<div class="row" style="padding:10px 0;">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#produks" onclick="loaditems(1);"><i class="fa fa-search"></i> Cari Produk & PO</button>
					...
					<div class="grid-footer">
						<div class="row">
							...
							<div class="col-sm-offset-7 col-sm-3">
								...
								<button class="btn btn-primary btn-block hitung hide" type="button">Simpan</button>
							</div>
						</div>
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul class="nav nav-tabs" id="tab-4">
					...
					<li data-toggle="link-tab"><a href="#po" onclick="loadpo(1);">Purchase Order (PO)</a></li>
					...
					<div class="tab-pane" id="po">
						<div class="row">
							...
							<div class="form-group">
								...
								<select class="form-control " name="id_vendor" style="width:100%;" >
									<option value=""> Silahkan pilih Vendor</option>
									@foreach($vendor as $data)
										<option  value="{{ $data->id_vendor }}">{{ $data->nm_vendor }}</option>
									@endforeach
								</select>
							</div>
							</div>
