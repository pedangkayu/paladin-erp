					...
					<div class="grid simple">
						...
						<div class="grid-body no-border">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<select style="width:100%;" name="id_coa" id="coa" required>
										...
										<input type="hidden" name="perkiraan" value="{{ $coa_jumlah_sebelum_dibayar }}">
									</div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										<label>Hutang</label>
										<div class="form-control">{{ $coa_hutang }}</div>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" id="deskripsi" name="deskripsi" required class="form-control" value="Pembayaran Faktur">
							</div>
