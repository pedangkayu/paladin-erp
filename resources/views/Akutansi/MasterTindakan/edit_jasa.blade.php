...
@section('content')
<form method="post" action="{{ url('/mastertreatment/editjasa') }}">
				...
				<div class="grid-body no-border">
					...
					<div class="row">
							...
							<div class="form-group">
							   ...
							   <div class="form-group">
								...
								<label for="supplier">Akun Coa Disk Penjualan *</label>
									<select name="coa_rs"  class="form-control">
						             		<option value="">None</option>
						             		 {!! $coa_disk !!}
						             </select>
								</div>
						...
						<div class="col-sm-6">
							...
							<!-- 	<div class="col-md-6">
									...
									<input type="hidden" min="0" value="{{isset($jasa->persen_rs) ? $jasa->persen_rs : ''}}" name="persen_rs"  class="form-control" required/>
								<!-- </div> -->
								<div class="col-md-4">
					...
					<div class="table-responsive">
						<table class="table table-hover">
							<thead>
								<tr>
									<th width="30%">Lokasi &nbsp;<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Lokasi ini yang akan menentukan jasa  akan terlihat di poli mana saja "><i class="glyphicon glyphicon-question-sign"></i></a></th>
									<th width="50%" class="text-left">Butuh Pelaku &nbsp; ;<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Pelaku maksudnya butuh dokter/ yang menangani dokter"><i class="glyphicon glyphicon-question-sign"></i></a></th>
									<th></th>
							...
							<input type="hidden" name="id_service_detail[]" value="{{isset($key->id_service_detail) ? $key->id_service_detail : ''}}"></input>
								<select name="id_unit[]" id="id_unit" required="required" class="form-control">
						      ...
						      <td>
						     <select name="kebutuhan1[]" required class="form-control">
					...
					<div class="grid-footer">
						<div class="row">
							<div class="col-sm-2">
								<a href="{{ url('/mastertreatment/masterjasa') }}" class="btn btn-default btn-block">Batal</a>
							</div>
