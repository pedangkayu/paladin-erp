...
@section('content')
<form method="post" action="{{ url('/fakturpendapatan/edit') }}">
			...
			<div class="grid simple">
				...
				<div class="grid-body no-border">
								...
								<tr {{ $item->id_po > 0 ? 'data-po=true' : 'onclick="id_delete(\'items-' . $item->id_faktur_item . '\');"' }} class="item-barang" data-item="{{ $item->id_faktur_item }}">
									...
									<td>
										...
										<input type="number" data-form="qty" value="{{ $item->qty }}" name="qty[]" class="form-control text-right" required>
									  	...
									  	<input type="hidden" name="id_faktur_item[]" value="{{ $item->id_faktur_item }}" />
									  	<input type="hidden" name="old[]" value="{{ $item->id_faktur_item }}" />
					...
					<div class="grid-footer">
						<div class="row">
							<div class="col-sm-2">
								<a href="{{ url('/fakturpendapatan') }}" class="btn btn-default btn-block">Batal</a>
							</div>
