...
@section('meta')
	...
	<script type="text/javascript" src="{{ asset('/js/akunting/fakturpendapatan/view.js') }}"></script>
	<style>
				...
				<div class="row">
					<div class="col-sm-7">
						...
						<address>
							...
							<h4>{{ $faktur->nm_payer }} &nbsp;{{$faktur->nm_last}}</h4>
...
<div class="col-sm-3">
	...
	<div class="grid simple">
		...
		<div class="grid-body no-border">
			...
			<a class="btn btn-primary btn-block" href="{{ url('/fakturpendapatan/edit/' . $faktur->id_faktur) }}"><i class="pull-left fa fa-pencil"></i> Perbaharui</a>
			<a class="btn btn-primary btn-block" target="_blank" href="{{ url('/fakturpendapatan/print/' . $faktur->id_faktur) }}"><i class="pull-left fa fa-print"></i> Print</a>
	...
	<div class="grid simple">
		...
		<div class="grid-body no-border">
			...
			<a class="btn btn-white btn-block" href="{{ url('/fakturpendapatan') }}"><i class="pull-left fa fa-arrow-circle-left"></i> Kembali</a>
...
<div class="modal fade" data-backdrop="static" id="payment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<form method="post" action="{{ url('/fakturpendapatan/savejurnal') }}">
			...
			<div class="modal-content">
						...
						<div class="grid-body no-border">
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<h4>{{ number_format($faktur->amount_due,2,',','.') }}</h4>
								</div>
								<div class="col-sm-4">
									<strong>Sisa</strong>
									<h4>{{ number_format(($faktur->total - $faktur->amount_due),2,',','.') }}</h4>
					...
					<div class="grid simple">
						...
						<div class="grid-body no-border">
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label for="id_coa_bank">Metode Pembayaran</label>
										<select style="width:100%;" name="id_coa" id="id_coa_bank">
											@foreach($akun_bank as $bank)
												<option value="{{ $bank->id_coa }}">{{ $bank->nm_coa }}</option>
											@endforeach
										</select>
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<div class="input-group transparent">
											...
											<input type="text" name="total" id="total" required class="form-control" value="{{ $faktur->total - $faktur->amount_due }}">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="modal-footer">
					...
					<input type="hidden" name="coa_piutang" value="{{ $config->coa_piutang }}">
