...
@section('meta')
	<script type="text/javascript" src="{{ asset('/js/akunting/fakturpendapatan/index.js') }}"></script>
	<style type="text/css">
		td > .link{
			display: none;
		}
	...
	<div class="row">
							...
							<tr class="faktur-{{ $item->id_faktur }}">
								...
								<td>
									...
									<div class="link">
										<small>
											[
												<a href="{{ url('/fakturpendapatan/view/' . $item->id_faktur) }}">Lihat</a> |
												<a href="{{ url('/fakturpendapatan/edit/' . $item->id_faktur) }}">Edit</a> |
												<a target="_blank" href="{{ url('/fakturpendapatan/print/' . $item->id_faktur) }}">Print</a> |
		...
		<div class="col-sm-3">
			...
			<div class="grid simple">
				...
				<div class="grid-body no-border">
					<a href="{{ url('/fakturpendapatan/baru') }}" class="btn btn-primary btn-block">Buat Faktur</a>
				</div>
			</div>
