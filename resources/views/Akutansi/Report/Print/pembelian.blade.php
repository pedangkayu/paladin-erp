...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/akunting/fakturpembelian/laporan/pembelian.js') }}"></script>
...
<form method="get" action="{{ url('/fakturpembelian/printpembelian') }}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
