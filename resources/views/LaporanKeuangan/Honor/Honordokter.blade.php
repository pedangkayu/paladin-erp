...
@section('meta')
<script type="text/javascript" src="{{ asset('/js/honormedis/honordokter.js') }}"></script>
...
@section('content')
<form  method="get" action="{{url('/rekapjasamedis/printdokterpasien')}}" target="_blank">
	<div class="row">
		<!-- left -->
		<div class="col-sm-7">
					...
					<div class="row">
						<div class="col-sm-9">
							...
							<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label for="bulan">Dokter</label>
											<select class="select " style="width:100%;" name="id_karyawan" id="id_karyawan">
				             				<option value="">Pilih</option>
											@foreach($dokter as $row)
												<option value="{{ $row->id_dokter }}"> {{$row->nm_depan}} {{$row->nm_belakang}}</option>
											@endforeach
									...
									<div class="col-sm-6">
										<div class="form-group">
											<label for="tahun">Pasien</label>
												<select class="select " style="width:100%;" name="nama_pasien" id="nama_pasien">
				             				<option value="">Pilih</option>
											@foreach($pasien as $row)
												<option value="{{ $row->nama_pasien }}"> {{$row->nama_pasien}}</option>
											@endforeach
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="text-center">Jenis Medis</th>
