				...
				<table class="table table-striped table-flip-scroll cf">
					<thead>
						<tr>
							...
							<th><a href="javascript:;">NIS</a></th>
							<th><a href="javascript:;">Kelas</a></th>
					...
					<tbody>
						...
						<tr class="item_{{ $item->id_siswa }} items">
							<td>{{ $no }}</td>
							<td>
							...
							<td class="text-right">
								...
								<button type="button" class="close hapus" data-nama="{{ $item->nm_depan }}" data-id="{{ $item->id_siswa }}"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
								@endif
							</td>
						</tr>
						<?php $no++; ?>
