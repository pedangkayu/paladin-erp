			...
			<div class="grid-body no-border">
				<table class="table table-striped table-flip-scroll cf">
					<thead>
						<tr>
							<th>No</th>
							<th width="20%"><a href="javascript:;">Nama</a></th>
							...
							<td>
								...
								<div style="display:none;" class="tbl-opsi">
										<small>
											...
											<a href="{{ url('karyawan/update/'.$item->id_karyawan) }}"> &middot; Edit</a>
											@endif
										</small>
									</div>
								</td>
								...
								<td>
								<small class="text-muted">{{ Format::indoDate(date('y-m-d',strtotime($item->tgl_bergabung))) }}<br />
								{{ Format::hari($item->created_at) }}, {{ Format::jam($item->created_at) }}</small>
