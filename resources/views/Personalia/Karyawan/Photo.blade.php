...
<div class="col-md-12">
	<ul class="nav nav-tabs">
		<li><a href="{{ url('/karyawan/update/'.$id_karyawan) }}">Biodata</a></li>
		<li><a href="{{ url('/karyawan/keluarga/'.$id_karyawan) }}">Keluarga</a></li>
		<li><a href="{{ url('/karyawan/honor/'.$id_karyawan) }}">Honor</a></li>
