		...
		$(function(){
			...
			$('[name="tipe"]').click(function(){
				...
				if(prop == 1){
					...
					$('[name="id_klasifikasi"]').removeAttr('required');
					$('#inventaris').show();
					$('#hidden-inventaris').show();
				}
			});
			// $('[name="tipe"]').trigger('click');
					...
					<div class="grid-body no-border">
	                    ...
	                    <div class="form-group">
	                        <label for="id_satuan" class="form-label">Satuan Terkecil *</label>
								<button type="button" class="btn btn-danger btn-sm btn-small"><i class="fa fa-exclamation-triangle"/></i> Merubah Satuan Terkecil tanpa diikuti oleh perubahan Harga Jual, Tidak disarankan!</button>
	                        <span class="help"></span>
	                        <div class="controls">
	                         	<select style="width:100%;" id="id_satuan" name="id_satuan" required>
	                          	...
	                          	<small>gunakan satuan paling kecil, misal: Box dan Strip, maka yang dipilih adalah Strip</small>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="controls">
		                          <div class="radio">
									...
									<input id="inventaris1" type="radio" name="tipe" value="3" {{ $item->tipe == 3 ? 'checked="checked"' : '' }}>
			                        <label for="inventaris1">Inventaris</label>
			                      </div>
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-6">
                    		<div class="form-group">
		                        <label for="reuse" class="form-label">Pemakaian *</label>
		                        <span class="help"></span>
		                        <div class="controls">
		                          <div class="radio">
			                        <input id="use" type="radio" name="reuse" value="0" {{ $item->reuse == 0 ? 'checked="checked"' : '' }} >
			                        <label for="use">Sekali Pakai</label>
			                        <input id="reuse" type="radio" name="reuse" value="1" {{ $item->reuse == 1 ? 'checked="checked"' : '' }}>
			                        <label for="reuse">Berkali kali</label>
			                      </div>
		                        </div>
		                    </div>
                    	</div>
	                    ...
	                    <div class="form-group opsi-obat">
	                        ...
	                        <span class="help"></span>
	                        <div class="controls">
	                         	<select style="width:100%;" id="id_klasifikasi" name="id_klasifikasi" >
	                    ...
	                    <div class="row">
	                    	<div class="col-sm-6">
		                    	...
		                    	<div class="col-sm-6" id="hidden-inventaris">
									<div class="form-group">
				                        <label for="lokasi" class="form-label">Lokasi</label>
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="lokasi" id="lokasi" value="{{ $item->lokasi }}">
				                        </div>
				                    </div>
		                    	</div>
	                    </div>
						<div id="inventaris">
	                    	<div  class="row">
		                    	<div class="col-sm-6">
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="merk" id="merk" value="{{ $item->merk }}">
				                        </div>
				                    </div>
		                    	</div>
		                    	...
		                    	<div class="col-sm-6">
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="dimensi" id="dimensi" value="{{ $item->dimensi }}">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
							...
							<div class="row">
		                    	<div class="col-sm-6">
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="number" class="form-control text-right" name="tahun_beli" id="tahun_beli" value="{{ $item->tahun_beli }}">
				                        </div>
				                    </div>
		                    	</div>
		                    	...
		                    	<div class="col-sm-6">
		                    		<div class="form-group">
				                        ...
				                        <span class="help">(%)</span>
				                        <div class="controls">
				                          <input type="number" class="form-control text-right" name="kondisi" id="kondisi" value="{{ $item->kondisi }}">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
		                    <div  class="row" >
		                    	<div class="col-sm-6" >
		                    		<div class="form-group">
				                        <label for="tahun_beli" class="form-label">Waktu Penyusutan</label>
				                        <span class="help"> (Tahun)</span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="waktu_penyusutan" id="waktu_penyusutan" value="{{$item->waktu_penyusutan}}">
				                        </div>
				                    </div>
		                    	</div>
		                    	...
		                    	<div class="col-sm-6 ">
		                    		<div class="form-group">
				                        <label for="kondisi" class="form-label">Nilai Penyusutan</label>
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="number" class="form-control text-right" name="nilai_penyusutan" id="nilai_penyusutan" value="{{$item->nilai_penyusutan}}">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
		                    <div class="row">
		                    	<div class="col-sm-6 ">
		                    		<div class="form-group">
				                        <label for="kondisi" class="form-label">Kode Lama</label>
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="kode_lama" id="kode_lama" value="{{$item->kode_lama}}">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
