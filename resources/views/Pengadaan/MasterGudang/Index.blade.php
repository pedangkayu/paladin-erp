					...
					<table class="table table-hover table-striped">
						...
						<tbody class="content-gudang">
							<?php 
							  ...
							  $no = $items->currentPage() == 1 ? 1 : ($items->perPage() + $items->currentPage()) -1 ;  
							   ?>
							@forelse($items as $item)
								<tr class="item-{{ $item->id_gudang }}">
									...
									<td>
										...
										<small>
											<a href="{{ url('/gudang/edit/' . $item->id_gudang) }}">Edit</a> &middot;
				...
				<div class="grid-body no-border">
					...
					@endif
						...
						<div class="form-group">
							...
							<input type="text" name="alias" value="{{ old('alias') ? old('alias') : !empty($gudang->alias) ? $gudang->alias : '' }}" required class="form-control">
						</div>
