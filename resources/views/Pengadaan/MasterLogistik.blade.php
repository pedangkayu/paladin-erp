...
@section('content')
	...
	<div class="row">
		<div class="col-sm-9">
			<div class="grid simple">
				<div class="grid-title no-border">
		          	<h4><span class="total-items">{{ number_format($items->total(),0,',','.') }}</span> Item <span class="semi-bold">ditemukan</span></h4>
		          	<div class="tools">
				...
				<div class="grid-body no-border table-responsive table-hover">
					<table class="table table-striped">
						<thead>
							<tr>
								<th>No</th>
								<th><a href="javascript:;">Nama Item</a></th>
		...
		<div class="col-sm-3">
			...
			<div class="grid simple">
				<div class="grid-title no-border">
					<h4>Cari <span class="semi-bold">Item</span></h4>
					<div class="tools">
		          		<a href="javascript:;" class="collapse"></a> 
		          	</div>
				</div>
