...
@section('content')
	...
	<div class="row">
		...
		<div class="col-sm-5">
			...
			@if($item->tipe == 3) <!-- ITEM INVENTARIS -->
			<div class="grid simple">
				<div class="grid-title no-border">
					<h4><strong>Detail</strong> Inventaris</h4>
					<div class="tools">
		          		<a href="javascript:;" class="collapse"></a> 
		          	</div>
				</div>
				<div class="grid-body no-border">
					<address>
						...
						<strong>Waktu Penyusutan (/tahun)</strong>
						<p>{{ $item->waktu_penyusutan }}</p>

						<strong>Nilai Penyusutan (Rp.)</strong>
						<p>Rp. {{ number_format($item->nilai_penyusutan,0,',','.') }}</p>
					</address>
				</div>
			</div>
			@endif <!-- EOF ITEM INVENTARIS -->
