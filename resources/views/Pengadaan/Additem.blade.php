			...
			<div class="col-sm-8">
					...
					<div class="grid-body no-border">
						<form method="post" action="">
							...
							<div class="form-group">
		                        <label for="nm_barang" class="form-label">Nama Item *</label>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="controls">
		                         	<select style="width:100%;" id="id_satuan" name="id_satuan" required>
		                          	...
		                          	<small>Ambilah satuan paling kecil Contoh BOX dan Strip maka yang dipilih adalah Strip</small>
		                        </div>
		                    </div>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label for="stok_awal" class="form-label">Tipe Item *</label>
										<span class="help"></span>
										<div class="controls">
											<div class="radio">
												<input id="obat" type="radio" name="tipe" value="1">
												<label for="obat">Obat</label>
												<input id="barang" type="radio" name="tipe" value="2">
												<label for="barang">Barang</label>
												<input id="inventaris1" type="radio" name="tipe" value="3" checked="checked">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="controls">
											  <div class="radio">
												<input id="use" type="radio" name="reuse" value="0" checked="checked">
												<label for="use">Sekali Pakai</label>
												<input id="reuse" type="radio" name="reuse" value="1">
		                    ...
		                    <div class="row">
		                    	...
		                    	<div class="col-sm-6" id="hidden-inventaris">
									<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="lokasi" id="lokasi" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
							...
							<div  class="row">
		                    	<div class="col-sm-6">
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="merk" id="merk" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    	...
		                    	<div class="col-sm-6" >
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="dimensi" id="dimensi" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
							<div  class="row" >
		                    	<div class="col-sm-6" >
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="number" class="form-control text-right" name="tahun_beli" id="tahun_beli" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    	...
		                    	<div class="col-sm-6 ">
		                    		<div class="form-group">
				                        ...
				                        <span class="help">(%)</span>
				                        <div class="controls">
				                          <input type="number" class="form-control text-right" name="kondisi" id="kondisi" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
		                    <div  class="row" >
		                    	<div class="col-sm-6" >
		                    		<div class="form-group">
				                        ...
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="waktu_penyusutan" id="waktu_penyusutan" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    	...
		                    	<div class="col-sm-6 ">
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="nilai_penyusutan" id="nilai_penyusutan" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
		                    <div class="row">
		                    	<div class="col-sm-6 ">
		                    		<div class="form-group">
				                        ...
				                        <span class="help"></span>
				                        <div class="controls">
				                          <input type="text" class="form-control text-right" name="kode_lama" id="kode_lama" value="">
				                        </div>
				                    </div>
		                    	</div>
		                    </div>
				...
				<div class="grid simple">
					...
					<div class="grid-body no-border">
						...
						<h3>Detail <span class="semi-bold">Item</span></h3>
						<p>
