			...
			<div class="grid simple">
				...
				<div class="grid-body no-border">
					<address>
						...
						<p>{{ empty($skb->nm_gudang) ? 'Tidak ditentukan' : $skb->nm_gudang }}</p>
					</address>

					<div class="form-group">
						<a class="btn btn-block btn-primary" href="{{ url('/skb/batchview/' . $skb->id_skb) }}"><i class="fa fa-barcode"></i> Detail Batch</a>
					</div>
				</div>
			</div>
