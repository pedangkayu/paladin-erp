				...
				<table class="table table-striped table-flip-scroll cf">
					<thead>
						<tr>
							...
							<th><a href="javascript:;">Akun Persediaan</a></th>
							<th><a href="javascript:;">Akun HPP (Pembelian)</a></th>
		...
		<div class="col-sm-4">
			<div class="grid simple">
				...
				<div class="grid-body no-border">
					...
					<div class="form-group">
						<label>Akun Persediaan (Pembelian)</label>
					...
					<div class="form-group">
						<label>Akun HPP (Penjualan)</label>
