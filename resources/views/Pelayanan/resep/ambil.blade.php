...
@section('content')
	...
	<div class="row">
		...
		<form method="post" action="{{ url('/resep/ambil') }}">
					
					<div class="text-right">
					@if($data->status_resep < 1)
						<button class="btn btn-primary" type="submit">Ambil Semua</button>
					@endif
					...
					<div class="grid-body no-border">
						<div class="table-responsive">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th width="25%" class="text-right text-middle">Nama </th>
										<th width="15%" class="text-right text-middle">Stok Apotik</th>
										<th width="20%" class="text-right text-middle">Jumlah</th>
