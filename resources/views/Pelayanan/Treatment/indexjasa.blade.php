...
@section('meta')
	 <!--  -->
<script type="text/javascript" src="{{ asset('js/treatment/searchjasa.js') }}"></script>
...
<div class="row">
		...
		<div class="grid simple">
			...
			<div class="grid-body no-border text-center">
				...
				<a href="{{ url('/jasa/create') }}" class="btn btn-primary btn-block dropdown-toggle" > Buat Treatment <span class="caret"></span></a>
				</div>
			</div>
		</div>
