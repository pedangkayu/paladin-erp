			...
			<div class="grid simple">
				...
				<div class="grid-body no-border">
					...
					<div class="col-sm-12">
						<table class="table table-bordered table-hover">
								<tr>
									<td>Pilih Dokter</td>
									<td colspan="2">
										<select style="width:100%;" name="id_karyawan" id="id_karyawan" >
								...
								<tr>
									...
									<td >
										...
										<td rowspan="4"><button type="button" class="btn btn-primary cari-pasien" data-toggle="modal" data-target="#pasien">
										<i class="fa fa-search"></i> Cari</button><br><br>
								           <div class="form-group">
											<div class="form-label">Pilih Kategori</div>
											<div class="control">
								...
								<tr>
									<td> Nama</td>
									<td><input type="hidden" value="{{ date('m/d/Y') }}" name="tanggal" id="tanggal" class="form-control" readonly="readonly">
										<input type="hidden" value="{{ date('m/d/Y') }}" name="tanggal_p" id="tanggal_p" class="form-control" readonly="readonly">
										<input class="form-control" name="NAMA_PASIEN"  rows="4"  required>
									</td>
								</tr>
								<tr><td>Alamat</td>
								<td><input type="text" value=""  class="form-control" name="alamat_pasien"></td>
								</tr>
								<tr><td>Tanggal Lahir</td>
								<td><input type="text" value=""  class="form-control" name="tgllahir_pasien"></td>
								</tr>
					...
					<div class="row" style="padding:10px 0;">
						<div class="col-sm-12">
							<div class="form-group">
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#produks"><i class="fa fa-search"></i> Obat </button>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<ul class="nav nav-tabs" id="tab-4">
					...
					<li data-toggle="link-tab"><a href="#po">Obat Campur</a></li>
				</ul>
